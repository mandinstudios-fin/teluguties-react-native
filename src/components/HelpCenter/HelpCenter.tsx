            ...
            <ScrollView contentContainerStyle={styles.scrollview}>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.form}>
                        ...
                        <Text style={styles.msg}>about your problem plese drop your query</Text>
                        </View>

                        

                        <View style={styles.inputbox}>
                            <TextInput value={message} onChangeText={setMessage} style={styles.input}multiline={true} placeholder='Message...'/>
                        </View>
                        <View style={styles.submitbox}>
                            <TouchableOpacity style={styles.submitcontainer} onPress={sendMessageToAdmin}>
